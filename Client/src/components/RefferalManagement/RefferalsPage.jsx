  ...
  return (
    <div style={{ padding: "20px 30px", display: "flex", flexDirection: "column", gap: 10 }}>
      <div style={{ display: "flex", gap: 5 }}>
        ...
        <p style={{ textTransform: "capitalize", color: "#7D8995" }}>{location.pathname}</p>
      </div>
            ...
            <List>
              {refferalsItems.map((item, index) => (
                <ListItem
                  ...
                  sx={{
                    border: selectedRefferalsItem?.name === item.name ? "2px solid #6255FA" : "2px solid #000",
                    borderRadius: "6px",
                    display: "flex",
                    alignItems: "center",
                    ...
                    backgroundColor: selectedRefferalsItem?.name === item.name ? "#6255FA" : "transparent",
                    "& .MuiListItemIcon-root": {
                      color: selectedRefferalsItem?.name === item.name ? "#fff" : "#000",
                    },
